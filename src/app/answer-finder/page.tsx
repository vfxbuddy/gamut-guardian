...
import { flashcards, glossaryTerms, guideArticles, scenarios } from "@/lib/data";
...
export default function AnswerFinderPage() {
  return (
    <div className="grid gap-5">
      ...
      <AnswerFinder flashcards={flashcards} scenarios={scenarios} guides={guideArticles} terms={glossaryTerms} />
    </div>
  );
}
