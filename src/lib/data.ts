...
export const flashcards: Flashcard[] = [
  ...
  },
  {
    ...
    aliases: ["ACEScc", "ACCT", "ACES CCT", "ACES cc t", "grading space", "log curve", "colorist"],
    sourceIds: ["aces-docs-overview"],
  },
  {
    id: "fc-lmt",
...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    aliases: ["ACCT", "ACES CCT", "ACES cc t", "grading space", "log AP1", "colorist space"],
    questions: ["What is ACEScct?", "What is ACCT?", "Should I comp in ACEScct?", "ACEScc vs ACEScct?"],
